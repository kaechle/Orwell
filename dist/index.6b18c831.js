...
})({"k8kHK":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
parcelHelpers.export(exports, "orwell", ()=>orwell
);
parcelHelpers.export(exports, "renderMarkdown", ()=>renderMarkdown
);
marked.setOptions({
...
},{"./assets/img/icon-menu.svg":"cyN2z","./assets/img/icon-close.svg":"aqKgE","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cyN2z":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('5tUvQ') + "icon-menu.fef5ddfe.svg" + "?" + Date.now();
...
},{}],"aqKgE":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('5tUvQ') + "icon-close.7c40be73.svg" + "?" + Date.now();
...
},{}]},["k8kHK","i3Wj0"], "i3Wj0", "parcelRequire94c2")
